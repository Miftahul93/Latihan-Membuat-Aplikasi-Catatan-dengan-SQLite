...
import com.example.mynoteapp.db.DatabaseContract.NoteColumns.Companion.DATE
import com.example.mynoteapp.db.NoteHelper
...
class NoteAddUpdateActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(view: View) {
        if (view.id == R.id.btn_submit) {
            ...
            val desciption = binding.edtDescription.text.toString().trim()
            ...
            values.put(DatabaseContract.NoteColumns.DESCRIPTION, desciption)
            ...
            if (isEdit) {
                ...
                if (result > 0) {
                    ...
                    Toast.makeText(this@NoteAddUpdateActivity, "Gagal Mmenambahkan data", Toast.LENGTH_SHORT).show()
                }
            }
        }
    }
